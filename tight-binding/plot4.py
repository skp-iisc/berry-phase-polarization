...
times_40, P_dyn_40 = calc_dyn_pol_el(E_max, T_ramp=40, N=200, t_max=160)
times_80, P_dyn_80 = calc_dyn_pol_el(E_max, T_ramp=80, N=200, t_max=160)
...
times_40_100k, P_dyn_40_100k = calc_dyn_pol_el(E_max, T_ramp=40, N=140, t_max=160)
...
plt.yticks([0, 0.001, 0.002], fontsize=14)
...
plt.yticks([0.00215, 0.00220, 0.00225], fontsize=14)
