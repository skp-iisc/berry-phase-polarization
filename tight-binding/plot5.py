...
E_max = 0.05
times_40_800, P_dyn_40_800 = calc_dyn_pol_el(E_max, T_ramp=40, N=800, t_max=160)
times_80_800, P_dyn_80_800 = calc_dyn_pol_el(E_max, T_ramp=80, N=800, t_max=160)
print("Simulating 400 k-point inset comparison...")
times_40_400, P_dyn_40_400 = calc_dyn_pol_el(E_max, T_ramp=40, N=400, t_max=160)
...
plt.xlim(0, 120)
plt.ylim(0, 0.005)
plt.xticks([0, 40, 80, 120], fontsize=14)
plt.yticks([0, 0.001, 0.002, 0.003, 0.004], fontsize=14)
...
plt.xticks([40, 60], fontsize=14)
plt.yticks([0.0043, 0.0044, 0.0045], fontsize=14)
